import { SearchImages } from '../../../constants';
            ...
            <div className={classes['text-container']}>
                <p>
                    ...
                    <span>
                        ...
                        watching cool dynamic animations, try the visualizer on your own! Have
                        a look at how we animated the two main search algoirthms, linear search
                        and binary search that are the most commonly used.
                    </span>
                </p>
                <p>
                    <i className="fa fa-angle-right" />
                    <span>
                        Our visualizer does not give you the same animation all the time.
                        Instead, you are the one who has absolute control over the visualizer
                        itself and that means you can set size, speed, and more importantly,
                        compare the sorting performance of different algorithms. You can
                        compare linear search with binary search at the same time by selecting
                        both!
                    </span>
                </p>
            </div>
    ...
    return (
        <div className={`${classes['sorting-intro']} ${classes['sorting-intro-ending']}`}>
            ...
            <p className={classes['ending-p']}>
                Try duo mode and compare the runtime of different searching algorithms!{' '}
                <strong>Binary search</strong> may be faster than you think!
            </p>
            <img
                src={SearchImages.SearchComparison}
