	...
	return (
		<div className={classes["sorting-intro"]}>
			...
			<div className={classes["text-container"]}>
				<p>
					<span>
						If you want to explore sorting algorithms, try the visualizer on your own!
						Have a look at how we animated the most popular sorting algorithms existing
						in the world.
					</span>
				</p>
		...
		<div className={`${classes["sorting-intro"]} ${classes["sorting-intro-algorithms"]}`}>
			...
			<ul className={classes["algorithms-list"]}>
				...
				<li>
					...
					<span className={classes.brief}>
						In place and <strong>NOT</strong> stable. Generally efficient, and commonly
						used.
					</span>
				</li>
				<li>
			...
			<div className={classes["definition-box"]}>
				...
				<p>
					...
					<span>means maintaining the relative order of records with equal keys</span>
				</p>
			</div>
		</div>
	);
...
const IntroEnding: React.FC = () => {
	return (
		<div className={`${classes["sorting-intro"]} ${classes["sorting-intro-ending"]}`}>
			...
			<img src={SortingComparisonImage} alt="sorting comparison" className={classes.img} />
		</div>
	);
};
